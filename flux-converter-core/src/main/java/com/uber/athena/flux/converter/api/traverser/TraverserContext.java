...
/**
 * Defines the program execution context for a {@code Traverser}.
 *
 * <p>This class is the base class for all program contexts. It provides
 * additional contextual information for a Traverser to complete its conversion.
 */
