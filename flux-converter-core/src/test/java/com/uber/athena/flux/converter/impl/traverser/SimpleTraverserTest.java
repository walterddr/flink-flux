...
import com.uber.athena.flux.converter.impl.testutils.rule.SimpleDslConversionRules;
import com.uber.athena.flux.converter.impl.testutils.rule.SimpleElementCreationRules;
import com.uber.athena.flux.converter.impl.testutils.rule.SimpleElementLinkageRule;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

public class SimpleTraverserTest extends TraverseTestBase {
