...
package com.uber.athena.dsl.planner.flink.relation.rules.table.source;
...
/**
 * Connect a {@link TableSource} with the table environment.
 */
public class TableSourceRule extends BaseFlinkTableRule {

  @Override
  public RuleCall onMatch(RuleCall ruleCall) {
    getTableEnv().registerTableSource(
        ruleCall.getVertexId(),
