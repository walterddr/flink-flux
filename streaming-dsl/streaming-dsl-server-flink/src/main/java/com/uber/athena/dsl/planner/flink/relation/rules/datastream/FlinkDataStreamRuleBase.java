 ...
 */
public interface FlinkDataStreamRuleBase {

  /**
   * Get the {@link StreamExecutionEnvironment} for the runtime.
   *
   * @return the execution environment used for generating job graph.
   */
