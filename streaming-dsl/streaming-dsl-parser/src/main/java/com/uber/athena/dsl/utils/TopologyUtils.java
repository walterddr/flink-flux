...
public final class TopologyUtils {
  ...
  public static void addAllOperators(
      TopologyDef def,
      Collection<OperatorDef> operators, boolean override) {
  ...
  public static void addAllSources(
      TopologyDef def,
      Collection<SourceDef> sources, boolean override) {
  ...
  public static void addAllSinks(
      TopologyDef def,
      Collection<SinkDef> sinks, boolean override) {
  ...
  public static void addAllComponents(
      TopologyDef def,
      Collection<ComponentDef> components, boolean override) {
  ...
  public static void addAllStreams(
      TopologyDef def,
      Collection<StreamDef> streams, boolean override) {
