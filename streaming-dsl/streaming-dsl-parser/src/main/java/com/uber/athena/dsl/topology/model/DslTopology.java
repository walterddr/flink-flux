...
public class DslTopology implements Topology {
  ...
  private final Map<String, Vertex> sources;
  private final Map<String, Vertex> sinks;
  private final Map<String, Vertex> operators;
  ...
  @Override
  public Map<String, Vertex> getOperators() {
    return operators;
  }

  @Override
  public Map<String, Vertex> getSources() {
    return sources;
  }

  @Override
  public Map<String, Vertex> getSinks() {
    return sinks;
  }
