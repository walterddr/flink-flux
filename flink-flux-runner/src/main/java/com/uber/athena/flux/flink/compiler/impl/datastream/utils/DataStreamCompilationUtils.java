...
public final class DataStreamCompilationUtils {
  ...
  public static void compileOperator(
    ...
    if (vertex.getIncomingEdge().size() == 1) {
      ...
      DataStream sourceStream = (DataStream) source.getCompilationResult();
      ...
      StreamDef stream0 = vertex.getIncomingEdge().get(0);
      StreamDef stream1 = vertex.getIncomingEdge().get(1);
      ...
      DataStream leadSourceStream = ((DataStreamCompilerVertex) leadSource).getCompilationResult();
      DataStream followSourceStream =
          ((DataStreamCompilerVertex) followSource).getCompilationResult();
